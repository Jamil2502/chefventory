...
class _InventoryScreenState extends State<InventoryScreen> {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        children: [
          ...
          // Inventory List with Pull-to-Refresh
          Expanded(
            child: StreamBuilder<List<Ingredient>>(
              ...
              builder: (context, snapshot) {
                if (snapshot.connectionState == ConnectionState.waiting) {
                  return InventorySkeletonLoader(itemCount: 5);
                }
                ...
                switch (_selectedFilter) {
                  ...
                  case 'Expiring Soon':
                    ingredients = ingredients
                        .where((ingredient) => ingredient.isExpiringSoon(7))
                        .toList();
                    break;
                  case 'Expired':
                    ingredients = ingredients
  ...
  Widget _buildIngredientCard(Ingredient ingredient, BuildContext context) {
    ...
    } else if (ingredient.isExpiringSoon(7)) {
