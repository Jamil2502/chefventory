          ...
          children: [
            ...
            Consumer<InventoryProvider>(
              builder: (context, inventoryProvider, child) {
                ...
                final expiredCount = inventoryProvider.expiredIngredients.length;
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            _buildIngredientItem('Ground Beef', '15.2 kg', 85, AppTheme.primaryBrown),
            _buildIngredientItem('Tomatoes', '12.8 kg', 72, AppTheme.errorRed),
            _buildIngredientItem('Cheese', '8.5 kg', 65, AppTheme.warningYellow),
            _buildIngredientItem('Lettuce', '6.2 kg', 58, AppTheme.successGreen),
            _buildIngredientItem('Onions', '4.8 kg', 45, AppTheme.brown),
          ],
        ),
      ),
    );
